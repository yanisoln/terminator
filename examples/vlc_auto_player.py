...
async def play_livestream_youtube_video(youtube_link):
    ...
    try:
        ...
        await vlc_window.press_key('{Ctrl}n')
        ...
        edit_box = combo.locator('role:Edit')
        await edit_box.click()
        await edit_box.press_key('{Ctrl}a')
        await edit_box.press_key('{Delete}')
        await edit_box.type_text(youtube_link)
        await asyncio.sleep(0.5)
